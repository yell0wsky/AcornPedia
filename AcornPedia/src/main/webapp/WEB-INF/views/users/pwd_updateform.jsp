...
></script>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/pwdupdateform.css"
/>
<link rel="stylesheet"
		...
		<div id="container">
			<div id="top-a">
				...
				<form
					...
					<label for="pwd">기존 패스워드</label> <input type="password" name="pwd"
						id="pwd" style="height: 20px;"
					/> <label for="newPwd">새 패스워드</label> <input type="password"
						name="newPwd" id="newPwd" style="height: 20px;"
					/> <label for="newPwd2">새 패스워드 확인</label> <input type="password"
						id="newPwd2" style="height: 20px;"
					/> <br>
