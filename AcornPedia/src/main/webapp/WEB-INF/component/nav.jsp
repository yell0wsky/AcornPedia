            ...
            <div class="login-body">
               <form class="animate__animated_animate__bounceInDown"
                  ...
                  <a href="${pageContext.request.contextPath}/users/signup_form.do"
                     class="navbar-atext navbar-margin navbar-color" data-dismiss="modal"
                     data-toggle="modal" data-target="#signupmodal"><span>회원가입</span></a>
               </form>
            </div>
         </div>
      </section>
